...
Partial Class Adopters
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Adopters))
        Panel1 = New Panel()
        Label5 = New Label()
        Label4 = New Label()
        Label3 = New Label()
        ...
        Panel2.Location = New Point(28, 244)
        ...
        ComboBox3.Items.AddRange(New Object() {"Male", "Female", "Other"})
        ...
        ComboBox1.Text = "Has Prior Experience"
        ' 
        ' TextBox2
        ' 
